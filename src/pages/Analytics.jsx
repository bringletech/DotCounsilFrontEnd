...
/>
  ...
  <div className='w-1/2'>
  <ChartCard title={"Enrollment Trends"} type={"line"} data={lineData} options={options}></ChartCard>
  </div>
  <div className='w-1/2'>
  <ChartCard title={"Conversion Funnel"} type={"bar"} data={convProgressBarData} options={progressBarOptions}></ChartCard>
  </div>
  </div>

    <div className='w-full h-auto mt-5'>
      <ChartCard title={"revenue analysis chart "} type={"bar"} data={RevenueBarData} options={options}></ChartCard>
    </div>
