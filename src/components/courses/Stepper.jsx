...
const steps = ["Basic Details", "Modules", "Lessons", "Quiz", "Review"];
  ...
  return (
    <div className="w-full  ">
      ...
      <div className="border-2 border-gray-300 flex w-full px-15 h-30 ">
          ...
          <div key={index} className="flex-1 flex flex-row gap-2 items-center">
            <div
            ...
            <p
              className={`mt-2 text-sm ${
                index === currentStep ? "text-black font-bold" : "text-gray-500"
              }`}
            >
              {step}
            </p>
      ...
      <div className="border p-6 rounded bg-white shadow">
        ...
        {currentStep === 1 && <Modules />}
        {currentStep === 2 && <Lessons />}
        {currentStep === 3 && <Quiz />}
...
const BasicDetails = () => <div>👉 Basic Details Form</div>;
const Modules = () => <div>👉 Module Form</div>;
const Lessons = () => <div>👉 Lessons Form</div>;
